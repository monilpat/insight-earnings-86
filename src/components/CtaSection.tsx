    ...
    <section className="section-container" id="join-launch">
      <div className="relative max-w-5xl mx-auto overflow-hidden rounded-2xl">
        ...
        <div className="relative z-10 px-6 py-16 md:py-20 text-center">
          <h2 className="heading-md text-white mb-8">JOIN $GABBY TOKEN LAUNCH</h2>
          <div 
          ...
          >
            ...
            {isHovering && (
              <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-gabby-dark text-white px-4 py-2 rounded-lg z-20 text-sm font-medium animate-fade-in">
                Coming Soon
              </div>
            )}
          </div>
